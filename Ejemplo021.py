...
dataDPt2 = clf2.predict(dataD)
PrMat2 = precision_score(dataR, dataDPt2, average='macro')
Prt2 = precision_score(dataR, dataDPt2, average=None)
Rct2 = recall_score(dataR, dataDPt2, average=None)
F1t2 = f1_score(dataR, dataDPt2, average=None)
...
dataDPt3 = clf3.predict(dataD)
PrMat3 = precision_score(dataR, dataDPt3, average='macro')
Prt3 = precision_score(dataR, dataDPt3, average=None)
Rct3 = recall_score(dataR, dataDPt3, average=None)
F1t3 = f1_score(dataR, dataDPt3, average=None)
...
dataDPt4 = clf4.predict(dataD)
PrMat4 = precision_score(dataR, dataDPt4, average='macro')
Prt4 = precision_score(dataR, dataDPt4, average=None)
Rct4 = recall_score(dataR, dataDPt4, average=None)
F1t4 = f1_score(dataR, dataDPt4, average=None)
...
dataDPt5 = clf5.predict(dataD)
PrMat5 = precision_score(dataR, dataDPt5, average='macro')
Prt5 = precision_score(dataR, dataDPt5, average=None)
Rct5 = recall_score(dataR, dataDPt5, average=None)
F1t5 = f1_score(dataR, dataDPt5, average=None)
...
dataDPt6 = clf6.predict(dataD)
PrMat6 = precision_score(dataR, dataDPt6, average='macro')
Prt6 = precision_score(dataR, dataDPt6, average=None)
Rct6 = recall_score(dataR, dataDPt6, average=None)
F1t6 = f1_score(dataR, dataDPt6, average=None)
...
dataDPt7 = clf7.predict(dataD)
PrMat7 = precision_score(dataR, dataDPt7, average='macro')
Prt7 = precision_score(dataR, dataDPt7, average=None)
Rct7 = recall_score(dataR, dataDPt7, average=None)
F1t7 = f1_score(dataR, dataDPt7, average=None)
...
## SVM
clf8 = LinearSVC(random_state=0)

clf8 = clf8.fit(dataD, dataR)
dataDP8 = clf8.predict(dataDT)

dataDPt8 = clf8.predict(dataD)
PrMat8 = precision_score(dataR, dataDPt8, average='macro')
Prt8 = precision_score(dataR, dataDPt8, average=None)
Rct8 = recall_score(dataR, dataDPt8, average=None)
F1t8 = f1_score(dataR, dataDPt8, average=None)

AccN8 = accuracy_score(dataRT, dataDP8)
Acc8 = accuracy_score(dataRT, dataDP8, normalize=False)
PrMa8 = precision_score(dataRT, dataDP8, average='macro')
PrMi8 = precision_score(dataRT, dataDP8, average='micro')
Pr8 = precision_score(dataRT, dataDP8, average=None)
RcMa8 = recall_score(dataRT, dataDP8, average='macro')
RcMi8 = recall_score(dataRT, dataDP8, average='micro')
Rc8 = recall_score(dataRT, dataDP8, average=None)
F1Ma8 = f1_score(dataRT, dataDP8, average='macro') 
F1Mi8 = f1_score(dataRT, dataDP8, average='micro') 
F18 = f1_score(dataRT, dataDP8, average=None)

print '-------------------------------'
print '------------SVM----------------'
print 'ACC: ', AccN8
print 'Pr: ', PrMa8, PrMi8
print Pr8
print 'Rc: ', RcMa8, RcMi8
print Rc8
print 'F1: ', F1Ma8, F1Mi8
print F18
...
clff1 = VotingClassifier(estimators=[('DT', clf1), 
                                    ...
                                    ('GNB', clf7)], 
                                    voting='soft', 
                                    weights=[PrMat1,PrMat2,PrMat3,PrMat4,PrMat5,PrMat6,PrMat7])
